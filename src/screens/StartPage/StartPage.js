    ...
    return (
        ...
        <>
            <div className=' min-h-screen bg-gray-900 flex flex-col justify-center items-center' >
                <div className=' flex flex-col items-center mt-2 justify-center p-20 bg-black ml-10 rounded-lg shadow-lg text-black    '>
                    ...
                    <div className='flex items-center content-center self-center text-white'>
                        ...
                        {signInPopup &&
                            <div className="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-75 flex items-center justify-center">
                                <div className="w-[600px] xl:w-[600px] bg-black p-4 rounded-lg shadow-lg transform transition-all ease-in-out duration-300 scale-100">
