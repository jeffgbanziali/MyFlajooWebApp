...
export const addStory = (data) => {
  return (dispatch) => {
    return axios
      .post('http://localhost:4000/api/stories/', data)
      .then((res) => {
...
export const likeStory = (storyId, userId) => {
  return (dispatch) => {
    return axios
      .patch(`http://localhost:4000/api/stories/like-story/${storyId}`, { id: userId })
      .then((res) => {
...
export const dislikeStory = (storyId, userId) => {
  return (dispatch) => {
    return axios
      .patch(`http://localhost:4000/api/stories/dislike-story/${storyId}`, { id: userId })
      .then((res) => {
...
export const viewStory = (storyId, viewerId) => {
  return (dispatch) => {
    return axios
      .patch(`http://localhost:4000/api/stories/view-story/${storyId}`, { viewerId })
      .then((res) => {
...
export const commentStory = (storyId, commenterId, text, commenterPseudo) => {
  return (dispatch) => {
    return axios
      .patch(`http://localhost:4000/api/stories/comment-story/${storyId}`, {
        commenterId,
        text,
        commenterPseudo,
      })
...
export const deleteStory = (storyId) => {
  return (dispatch) => {
    return axios
      .delete(`http://localhost:4000/api/stories/${storyId}`)
      .then((res) => {
