          ...
          <div className="flex flex-col sm:w-[30%] justify-center w-screen h-[100%] sm:h-[100%]   sm:mt-4 sm:rounded-2xl ">
            <div className="flex  sm:w-[100%] sm:h-[90%] w-[100%] h-[100%]  justify-center   sm:mt-0 mt-10 sm:rounded-2xl ">
              <div className="flex flex-col w-[100%] justify-center items-center sm:space-y-2  sm:ml-4 ml-2 sm:w-[28%]  sm:mt-4 absolute z-10">
                <div
                  className=" sm:w-[100%]  sm:items-center sm:justify-evenly sm:flex sm:flex-row "
                >
                  {selectedStory.container.stories.map((item, index) => (
                    <div
                      key={index}
                      className=" sm:w-[90%] sm:flex sm:flex-row   hidden sm:rounded-lg sm:bg-gray-500">
                      <div
                        className=" h-2 rounded-lg  bg-gray-200"
                        style={{ width: currentStoryIndex === index ? `${storyProgress}%` : selectedStory.container.stories[index].finish }}
                      ></div>
                    </div>
                  ))}
                </div>
            ...
            <div className="flex sm:bottom-0 justify-center  items-center  ">
              ...
              <div className="flex flex-row">
                ...
                <LikeStoriesButton store={selectedStory.container?.stories[currentStoryIndex]} />
              </div>
            </div>
          </div>
              ...
              <div className="flex  sm:w-[100%] sm:h-[90%]  rounded-2xl ">
                ...
                <>
                  ...
                  {selectedStory.container.stories[currentStoryIndex].media_type === 'image' && (
                    <img
                      src={selectedStory.container.stories[currentStoryIndex].media}
                      alt="user-img"
                  ...
                  {selectedStory.container.stories[currentStoryIndex].media_type === 'video' && (
                    ...
                    <video
                      ...
                      width="100%"
                    >
                      <source src={selectedStory.container.stories[currentStoryIndex].media} type="video/webm" />
                      <source src={selectedStory.container.stories[currentStoryIndex].media} type="video/mp4" />
                    </video>
                  )
                  }
