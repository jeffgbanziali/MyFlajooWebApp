        ...
        <div>
            {
                ...
                <Popup trigger={<div className="flex w-32 h-10 mt-2  bg-black hover:bg-red-800 cursor-pointer justify-center items-center rounded-2xl">
                    ...
                    <div className="flex flex-col justify-center items-center">
                        <p className="text-black text-sm font-normal text-justify sm:text-base md:text-lg lg:text-xl xl:text-sm">You must be logged in to like a post</p>
                    </div>
                </Popup>
            }
            {
                uid && liked === false && (
                    <div onClick={like} className="flex w-12 h-12 mt-2   hover:bg-gray-800 cursor-pointer justify-center items-center rounded-full">
            ...
            {
                uid && liked && (
                    <div onClick={unlike} className="flex w-12 h-12 mt-2   bg-black hover:bg-red-800 cursor-pointer justify-center items-center rounded-full">
