                                            ...
                                            <div className='flex flex-row items-center '>
                                                <div className='flex items-center'>
                                                    ...
                                                    <div className='flex flex-col ml-4 text-justify '>
                                                        <h2 className='text-center text-gray-900 font-semibold text-sm'>{friend.firstName}</h2>
                                                        <h2 className='text-center text-gray-900 font-normal text-[16px]'>@{friend.pseudo}</h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
